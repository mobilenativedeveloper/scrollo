...
struct PublicationTextPostView: View {
    ...
    var body: some View {
        ...
        .alert(isPresented: $addPost.alert.show) {
            Alert(title: Text(addPost.alert.title), message: Text(addPost.alert.message), dismissButton: .default(Text("Продолжить")))
        }
    }
}

struct PublicationTextPost_Previews: PreviewProvider {
    static var previews: some View {
        PublicationTextPostView()
    }
}

// MARK: Text color block
